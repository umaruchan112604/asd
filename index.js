...
const randomtext3 = [
  ...
  '𝓨𝓸𝓾 𝓬𝓪𝓷𝓽 𝓵𝓸𝓿𝓮 𝓪𝓷𝔂𝓸𝓷𝓮, 𝓬𝓪𝓾𝓼𝓮 𝓽𝓱𝓪𝓽 𝔀𝓸𝓾𝓵𝓭 𝓶𝓮𝓪𝓷 𝔂𝓸𝓾 𝓱𝓪𝓭 𝓪 𝓱𝓮𝓪𝓻𝓽',
  '𝓘 𝓽𝓻𝓲𝓮𝓭 𝔂𝓸𝓾 𝓱𝓮𝓵𝓹 𝔂𝓸𝓾 𝓸𝓾𝓽, 𝓷𝓸𝔀 𝓘 𝓴𝓷𝓸𝔀 𝓽𝓱𝓪𝓽 𝓘 𝓬𝓪𝓷𝓽',
  '𝓒𝓪𝓾𝓼𝓮 𝓱𝓸𝔀 𝔂𝓸𝓾 𝓽𝓱𝓲𝓷𝓴𝓼 𝓽𝓱𝓮 𝓴𝓲𝓷𝓭 𝓸𝓯 𝓽𝓱𝓲𝓷𝓰 𝓘𝓵𝓵 𝓷𝓮𝓿𝓮𝓻 𝓾𝓷𝓭𝓮𝓻𝓼𝓽𝓪𝓷𝓭',
...
🌡${roundedNumber} °C ⋆ 🍃 ${roundwNumber} m/s`)
      ...
      .addButton(`${randomButtonText}`, `${linkButtonone}`, MessageButtonStyles.PRIMARY)
